...
Arquivo relacionado à atividade 6.11 da parte 1.
"""
...
cities = {
    ...
    "Paris": {
        ...
        "fact": 
            "É conhecida como a \"Cidade Luz\" devido ao seu papel durante o Iluminismo."
    },
    "Rio de Janeiro": {
        "country": "Brasil",
...
for cidade, informacoes in cities.items():
    ...
    for titulo, informacao in informacoes.items():
        if len(informacao) > 10:
            tmp = textwrap.wrap(informacao, width=23)
